...
def get_parameters():
    ...
    # Path
    parser.add_argument('--image_path', type=str, default='Multimodal_data_generator/data')
    parser.add_argument('--log_path', type=str, default='Multimodal_data_generator/logs')
    parser.add_argument('--model_save_path', type=str, default='Multimodal_data_generator/models')
    parser.add_argument('--sample_path', type=str, default='Multimodal_data_generator/samples')
    parser.add_argument('--attn_path', type=str, default='Multimodal_data_generator/attn')
